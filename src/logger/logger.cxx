 ...
 * a single recursive mutex (returned by @ref mist::logger::AnchorObject::registry_lock).
 * Lock order across the codebase is registry → bar (i.e.
 * @ref mist::logger::AnchorObject::render_line overrides may acquire their own
 * internal mutex while the registry mutex is held by the caller of
 * @ref mist::logger::AnchorObject::redraw_all).
 */
