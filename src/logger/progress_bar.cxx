 ...
 * and then call @ref mist::logger::AnchorObject::erase_all and
 * @ref mist::logger::AnchorObject::redraw_all (which acquire the registry
 * mutex).  This keeps the lock order
