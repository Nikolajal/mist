...
//
// mist::algo is currently header-only: block_mean, block_rms, and
// moving_mean are templates instantiated at the call site. This TU exists
// so the mist static library has a concrete object file contribution for
// the algo module, and so non-template helpers added in the future have
// a home without restructuring the build.
//
